...
param_grid = [n_estimators_values, min_samples_split_values, min_samples_leaf_values]
...
def call_model(n_estimators, min_samples_split, min_samples_leaf):
    global X_train, y_train, X_test, y_test, X_val, y_val
    global best_model, best_mae, best_test_pred, best_param_list

    regr = ExtraTreesRegressor(n_estimators=n_estimators,
