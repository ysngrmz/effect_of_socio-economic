...
learning_rate_values = Real(low=1e-5, high=1e-1, name="learning_rate")
n_estimators_values = Integer(low=50, high=500, name="n_estimators")
max_leaf_nodes_values = Integer(low=2, high=50, name="max_leaf_nodes")
min_samples_leaf_values = Integer(low=2, high=50, name="min_samples_leaf")
tol_values = Real(low=1e-10, high=1e-5, name="tol")

param_grid = [learning_rate_values, n_estimators_values, max_leaf_nodes_values, min_samples_leaf_values, tol_values]
...
def call_model(learning_rate, n_estimators, max_leaf_nodes, min_samples_leaf, tol):
    global X_train, y_train, X_test, y_test, X_val, y_val
    global best_model, best_mae, best_test_pred, best_param_list

    regr = GradientBoostingRegressor(learning_rate=learning_rate,
