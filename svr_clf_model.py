...
gamma_values = Categorical([2 ** elem for elem in range(-10,11)], name="gamma")
c_values = Categorical([2 ** elem for elem in range(-10,11)], name="C")
tol_values = Real(low=1e-5, high=1e-1, name="tol")

param_grid = [gamma_values, c_values, tol_values]
