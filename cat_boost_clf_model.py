...
iterations_values = Integer(low=100, high=2000, name="iterations")
learning_rate_values = Real(low=0.001, high=1, name="learning_rate")
depth_values = Integer(low=2, high=10, name="depth")
reg_lambda_values = Real(low=0, high=0.9, name="reg_lambda")

param_grid = [iterations_values, learning_rate_values, depth_values, reg_lambda_values]
...
def call_model(iterations, learning_rate, depth, reg_lambda):
    ...
    if val_mae < best_mae:
        ...
        best_param_list = [["iterations", iterations], 
                           ["learning_rate",learning_rate],
                           ["depth",depth],
                           ["reg_lambda",reg_lambda]]
