...
criterion_values = Categorical(["squared_error", "absolute_error", "friedman_mse", "poisson"],name="criterion")
min_samples_split_values = Integer(low=2, high=20, name="min_samples_split")
min_samples_leaf_values = Integer(low=1, high=20, name="min_samples_leaf")

param_grid = [n_estimators_values, criterion_values, min_samples_split_values, min_samples_leaf_values]
...
def call_model(n_estimators, criterion, min_samples_split, min_samples_leaf):
    ...
    if val_mae < best_mae:
        ...
        best_param_list = [["n_estimators", n_estimators], 
                           ["criterion", criterion], 
                           ["min_samples_split",min_samples_split],
                           ["min_samples_leaf",min_samples_leaf]]
